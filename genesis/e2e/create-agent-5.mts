...
const HASH = "0x69d6acaa844a12ad29d318feaafee079c32e1e2565c1a1aa094a247990234550";
const EXPECTED_TREASURY = "0x03effa6299824ae0b81a73df71cb20e71135c23c";
...
const h2 = await wal.writeContract({ address: FACTORY, abi: fac, functionName: "createAgent", args: ["Vivarium Trader", "VIVTRD5", "", HASH, account.address, EXPECTED_TREASURY], ...fees });
