...
const HASH = "0xc29683501ffb287bb1828f211db9ccc8590cbdc39bec990e3a662e698ce56440";
const EXPECTED_TREASURY = "0xe5d2190897dffa7dd5675fcaf5790cae47aceb97";
...
const h2 = await wal.writeContract({ address: FACTORY, abi: fac, functionName: "createAgent", args: ["Vivarium Trader", "VIVTRD6", "", HASH, account.address, EXPECTED_TREASURY], ...fees });
