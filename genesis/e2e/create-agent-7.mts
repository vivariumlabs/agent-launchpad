...
const HASH = "0xe4d7fade7597e837e1025262b440cb926378fd370a81b8198ef1be7a82b735ec";
const EXPECTED_TREASURY = "0x272f1e151803ac5603e537aa0b44c7cc71892eea";
...
const h2 = await wal.writeContract({ address: FACTORY, abi: fac, functionName: "createAgent", args: ["Vivarium Trader", "VIVTRD7", "", HASH, account.address, EXPECTED_TREASURY], ...fees });
