...
const HASH = "0xcef2d36586df74cacb531781beec445006bffb2046c8b68ebb76f8c12a50883e";
const EXPECTED_TREASURY = "0x4c0b9e1b0dc190a67ee547b4b0ededbd21afd746";
...
const h2 = await wal.writeContract({ address: FACTORY, abi: fac, functionName: "createAgent", args: ["Vivarium E2E 3", "VIVE2E3", "", HASH, account.address, EXPECTED_TREASURY], ...fees });
